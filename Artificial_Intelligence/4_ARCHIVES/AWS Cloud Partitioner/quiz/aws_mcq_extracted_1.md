...
- [ ] D. Delivering computing resources through the internet with on-demand access and pay-as-you-go pricing.
...
- [ ] C. It shares the same physical networking infrastructure with nearby Regions for risk redundancy.
...
- [ ] C. Compliance -> Latency Optimization -> Service Availability -> Cost Optimization
...
- [ ] B. Multiple isolated data centers in one Region
...
- [ ] D. No, because an EBS volume is a zonal resource, creating a 'Single Point of Failure'
...
- [ ] C. A commercial bank with a large, stable customer base that must strictly comply with data security regulations.
...
- [ ] C. When the business wants to focus entirely on developing, running, and managing applications without worrying about maintaining the underlying infrastructure (OS, storage, networking).
...
- [ ] C. Patching and maintaining the underlying Operating System (OS).
...
- [ ] C. Managing data access permissions and user identities.
