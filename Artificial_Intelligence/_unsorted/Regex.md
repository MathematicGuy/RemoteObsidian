---
category: "_unsorted/Regex.md"
summary: "`\".\"` mean it match any characters -> match all chars but *only scan for 1 char*
`*` matches zero or more occurences -> `.*` -> *match all chars and scan for all chars*
`?` makes the match non-grad..."
keywords: []
confidence: "low"
analyzed_at: "2026-06-01T02:22:41.161617+00:00"
---
