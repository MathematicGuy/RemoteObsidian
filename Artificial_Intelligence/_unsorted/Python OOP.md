---
category: "_unsorted/Python OOP.md"
summary: "# OOP
#### `__init__`
+ ? The `__init__()` function is called automatically every time the class is being used by a Object, it just empty when you don't initialize it."
keywords: []
confidence: "low"
analyzed_at: "2026-06-01T02:22:41.155492+00:00"
---
# OOP
#### `__init__`
