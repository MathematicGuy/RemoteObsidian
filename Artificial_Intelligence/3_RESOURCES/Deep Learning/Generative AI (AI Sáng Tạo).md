---
category: "3_RESOURCES/Deep Learning/Generative AI (AI Sáng Tạo).md"
summary: "> AI model that generate new content from an original model
+ They **learn the underlying patterns** (mô hình cơ bản) **of the data** & use that knowledge **to create new contents.**

GAN (**Genera..."
keywords: []
confidence: "high"
analyzed_at: "2026-06-01T02:22:41.080332+00:00"
---
