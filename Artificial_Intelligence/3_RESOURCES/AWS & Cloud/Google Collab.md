---
category: "3_RESOURCES/AWS & Cloud/Google Collab.md"
summary: "## **Hardware Accelerator Options:**

These options allow you to select the type of hardware accelerator you want to use to speed up computations:

- **CPU**:
    
    - This option does not use an..."
keywords: []
confidence: "high"
analyzed_at: "2026-06-01T02:22:41.082586+00:00"
---
