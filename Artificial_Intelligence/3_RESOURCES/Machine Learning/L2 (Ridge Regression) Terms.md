---
category: "3_RESOURCES/Machine Learning/L2 (Ridge Regression) Terms.md"
summary: "1) **1st term:** $$\frac{1}{m}\sum^{m}_{i=1}(f_{\vec{w}, b}(\vec{x}^{(i)}) - y^{(i)})$$
- **Represents the training data**: This is the mean squared error (MSE) between the predicted values $f_{\ve..."
keywords: []
confidence: "high"
analyzed_at: "2026-06-01T02:22:41.104887+00:00"
---
