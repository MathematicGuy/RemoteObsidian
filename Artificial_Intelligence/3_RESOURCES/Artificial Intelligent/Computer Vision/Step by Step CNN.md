...
### Back Propagation 
+ ? During back prop the convolutio become Full Convolution, which requires flipping the kernel by 180 degrees (both horiontally and vertically) to align the gradients correctly. 
