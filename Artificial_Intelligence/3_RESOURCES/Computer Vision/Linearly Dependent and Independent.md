---
category: "3_RESOURCES/Computer Vision/Linearly Dependent and Independent.md"
summary: "A group of vectors is said to be **linearly independent if none of the vectors in the group can be obtained as a linear combination of the others.** or in other word
Example:
$v_{1}=(1, 0), v_{2}=(..."
keywords: []
confidence: "high"
analyzed_at: "2026-06-01T02:22:41.113912+00:00"
---
