---
category: "3_RESOURCES/Computer Vision/Division by 2 is taken just for scaling purposes.md"
summary: "In the context of linear regression and gradient descent optimization, the cost function is defined as:
$$E\left(m, b\right) = \frac{1}{2n}\sum_{i=1}^{n} \left(\hat{y}^{(i)} - y^{(i)}\right)^2 =
\f..."
keywords: []
confidence: "high"
analyzed_at: "2026-06-01T02:22:41.059120+00:00"
---
