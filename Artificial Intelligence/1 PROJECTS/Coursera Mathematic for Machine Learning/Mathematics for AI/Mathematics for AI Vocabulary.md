delve -> dive into/go deeperin sth
shearing -> xoay ngang. Rotate 2d Space in both x & y 
propagation - spread 
dissecting - mổ sẻ / phân rã và đi sâu vào 1 kthuc
specific - refer to a *single unique identify* or value or defined instance. It constrasts with *"variables"* that can represent *any value within a set*.  
